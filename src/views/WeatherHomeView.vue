...
// 공통 파일에 저장한 40개 도시 데이터를 반응형 배열로 관리
...
const isRecommended = (item) => {
  return !item.status.includes('비') && item.feelsLike >= 15 && item.feelsLike < 30 && item.pm10 <= 60 && item.pm25 <= 35
}
