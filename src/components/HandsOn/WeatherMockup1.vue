...
// 1. 배열 렌더링(v-for) - 2026-08-19 15:00(KST) 날씨 기준
    ...
    <section class="list-box">
      ...
      <div class="weather-grid">
        ...
        >
          ...
          <!-- 날씨에 따른 여행 도시 추천 -->
          <p v-if="item.status === '맑음'" class="travel-message recommend">
            ☀️ 맑은 하늘을 즐기며 야외 여행하기 좋습니다.
          </p>
          <p v-else-if="item.status === '대체로 맑음'" class="travel-message recommend">
            🌤️ 대체로 맑아 가벼운 야외 일정을 즐기기 좋습니다.
          </p>
          <p v-else-if="item.status === '구름 조금'" class="travel-message recommend">
            ⛅ 구름이 조금 있지만 여행하기 무난한 날씨입니다.
          </p>
          <p v-else-if="item.status === '흐림'" class="travel-message caution">
            ☁️ 흐린 날씨이니 야외 일정 전에 변화를 확인하세요.
          </p>
          <p v-else-if="item.status === '약한 이슬비'" class="travel-message caution">
            🌦️ 약한 이슬비가 내려 작은 우산을 챙기세요.
          </p>
          <p v-else-if="item.status === '강한 이슬비'" class="travel-message caution">
            ☔ 강한 이슬비가 내려 실내 여행지를 추천합니다.
          </p>
          <p v-else class="travel-message caution">
            🌍 여행 전 최신 날씨를 확인하시고, 즐거운 여행 계획하세요!
          </p>
