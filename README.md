...
URL의 `:cityId`로 Store에서 도시를 찾아 현재 날씨와 대기질을 표시했습니다. Axios 단계에서는 가까운 다섯 개의 3시간 예보도 추가했습니다.
...
- `/weather/:cityId`를 주소창에서 바로 열거나 새로고침해 Store가 비어 있으면 현재는 상세 도시를 찾지 못합니다.
...
다음 단계에서는 상세 Route 새로고침 복구와 관심 여행지 영구 저장을 먼저 개선할 수 있습니다.
